# Mathieu MOREL ***(Développeur PHP certifié Zend)***
...
> ***PHP 5.4, Symfony 2.8, Memcache, GIT, PHPUnit, REST, SOAP***
...
`Canal + Overseas` : Système permettant la création, la validation puis l'envoi via satellite
